...
const videoItems = document.querySelectorAll(".card-post-video");
const videoItems2 = document.querySelectorAll(".card-post-video-2");

document.addEventListener("DOMContentLoaded", function () {
    videoItems.forEach(function (item) {
        const posterImage = item.querySelector(".img_poster");
        const video = item.querySelector(".card-custom-video-re");
        video.style.display = "none";
        posterImage.style.display = "block";
        posterImage.addEventListener("click", function () {
            posterImage.style.display = "none";
            video.style.display = "block";
            video.load(); // Cargar el video (es necesario en algunos navegadores)
            video.play(); // Reproducir el video
        });
    });

    videoItems2.forEach(function (item) {
        const posterImage = item.querySelector(".img_poster-2");
        const video = item.querySelector(".card-custom-video-re-2");
        video.style.display = "none";
        posterImage.style.display = "block";
        posterImage.addEventListener("click", function () {
            posterImage.style.display = "none";
