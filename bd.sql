...
-- Volcando datos para la tabla network_eyngel.migrations: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla network_eyngel.muro_users: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla network_eyngel.persistent_sessions: ~38 rows (aproximadamente)
...
-- Volcando datos para la tabla network_eyngel.post_action: ~73 rows (aproximadamente)
...
-- Volcando datos para la tabla network_eyngel.post_comment: ~26 rows (aproximadamente)
...
-- Volcando datos para la tabla network_eyngel.post_user: ~20 rows (aproximadamente)
INSERT IGNORE INTO `post_user` (`pu_id`, `pu_id_user`, `pu_descripcion`, `pu_timestamp`, `pu_type`, `created_at`, `updated_at`) VALUES
	(144, 1, 'ppp', '2023-08-19 19:45:27', 'img', '2023-08-19 19:45:27', '2023-08-19 19:45:27'),
	(145, 1, 'Manu CHAO', '2023-08-19 19:45:42', 'movie', '2023-08-19 19:45:42', '2023-08-19 19:45:42'),
	(146, 1, 'Pista SENABOT', '2023-08-19 19:54:22', 'img', '2023-08-19 19:54:22', '2023-08-19 19:54:22'),
	(147, 2, 'Curso de robótica robot lego', '2023-08-19 20:01:59', 'img', '2023-08-19 20:01:59', '2023-08-19 20:01:59'),
	(148, 1, '¡Atención Yopal! 🌟📚 En la plaza de mercado, en este momento, es la hora de la oportunidad. 💼🎉 Te esperamos en la jornada de inscripciones para la cuarta convocatoria de formación presencial del SENA. ¡Tu futuro está a un paso de distancia!<br />\r\nAdemás, la APE Agencia Pública de Empleo del SENA está presente, listos para guiarte en el camino hacia nuevas oportunidades laborales. 💼🤝 Si estás cerca, ¡no dejes pasar esta oportunidad!', '2023-08-19 21:01:45', 'img', '2023-08-19 21:01:45', '2023-08-19 21:01:45'),
	(149, 1, '🚨 ¡OFICIAL! Galarasaray completó el acuerdo con Hakim Ziyech del Chelsea, está firmado ⚫🔴🇹🇷<br />\r\nAcuerdo de préstamo gratuito con cláusula de opción de compra gratuita para el marroquí que ha completado la medicina ayer 🇲🇦', '2023-08-19 21:02:49', 'img', '2023-08-19 21:02:49', '2023-08-19 21:02:49'),
	(150, 1, 'Inspiremos nuestra visión y capturemos sueños en cada imágenes que tomamos. 📷📸#DíaMundialDeLaFotografía #19deAgosto', '2023-08-19 21:11:48', 'hilo', '2023-08-19 21:11:48', '2023-08-19 21:11:48'),
	(152, 1, 'ppppppppppppppppppppppppppppppppppppppppppppppppppppppppppp', '2023-08-19 21:19:56', 'img', '2023-08-19 21:19:56', '2023-08-19 21:19:56'),
	(153, 1, '', '2023-08-19 22:42:02', 'img', '2023-08-19 22:42:02', '2023-08-19 22:42:02'),
	(156, 1, 'VI Encuentro de Semilleros de Investigación SENA Regional Casanare.', '2023-08-19 23:08:34', 'img', '2023-08-19 23:08:34', '2023-08-19 23:08:34'),
	(157, 1, 'asdf kjasjdaskjkljads', '2023-08-19 23:11:27', 'movie', '2023-08-19 23:11:27', '2023-08-19 23:11:27'),
	(158, 1, 'aaa', '2023-08-19 23:11:31', 'hilo', '2023-08-19 23:11:31', '2023-08-19 23:11:31'),
	(159, 1, 'Hoy juega messi, la final de la leagues CUP', '2023-08-20 00:57:50', 'hilo', '2023-08-20 00:57:50', '2023-08-20 00:57:50'),
	(161, 1, 'Madre mia que golazo, de leo messi.', '2023-08-20 01:40:15', 'hilo', '2023-08-20 01:40:15', '2023-08-20 01:40:15'),
	(165, 1, '🤔 No esperes más para estudiar un posgrado<br />\r\n⏰ En UNIMINUTO ORINOQUÍA, podrás estudiar la Especialización en gerencia de proyectos modalidad a distancia en menos tiempo. <br />\r\n✅ Conoce más e inscríbete sin costo aquí ✅', '2023-08-20 01:56:21', 'hilo', '2023-08-20 01:56:21', '2023-08-20 01:56:21'),
	(170, 1, '', '2023-08-20 02:05:40', 'movie', '2023-08-20 02:05:40', '2023-08-20 02:05:40'),
	(171, 1, 'Manu CHAO', '2023-08-20 02:12:00', 'movie', '2023-08-20 02:12:00', '2023-08-20 02:12:00'),
	(172, 1, '', '2023-08-20 02:35:28', 'img', '2023-08-20 02:35:28', '2023-08-20 02:35:28'),
	(173, 1, 'pppp', '2023-08-20 02:44:37', 'hilo', '2023-08-20 02:44:37', '2023-08-20 02:44:37'),
	(174, 1, '', '2023-08-20 02:44:47', 'img', '2023-08-20 02:44:47', '2023-08-20 02:44:47');
...
-- Volcando datos para la tabla network_eyngel.post_user_files: ~16 rows (aproximadamente)
...
-- Volcando datos para la tabla network_eyngel.tokens_count: ~17 rows (aproximadamente)
...
INSERT IGNORE INTO `users` (`id`, `u_nombre`, `u_apellido`, `u_nombre_usuario`, `u_descripcion_perfil`, `email`, `email_verified_at`, `password`, `u_sexo`, `u_ciudad_residencia`, `u_fecha_nacimiento`, `u_tokens`, `u_role`, `u_profesion`, `u_estado`, `u_session_id`, `u_ultima_conexion`, `u_img_profile`, `u_term_con`, `remember_token`, `confirmed`, `confirmation_code`, `created_at`, `updated_at`) VALUES
	(1, 'Michael', 'Rodriguez', 'michaelrodriguez', 'We are you lovin, Inter miami', 'maicolr62@gmail.com', '2023-08-20 02:11:16', '$2y$10$.rjgB4IKcvFJm38vi7RsT.T0H4ICbXE65TMQhfEnbiN/S8v58e0xm', 'H', 'Yopal', '2000-11-26', 0, 0, 'Ingeniero de sistemas', 1, NULL, NULL, 'images/img-profile-eyngel/michaelrodriguez-368875867_884901066770719_7665468039597356799_n.jpg', 1, NULL, 0, 'QtYOneyetbk77j44GP2ZLa4lK', '2023-07-31 23:48:44', '2023-07-31 23:48:44'),
...
-- Volcando datos para la tabla network_eyngel.users_verify_count: ~1 rows (aproximadamente)
