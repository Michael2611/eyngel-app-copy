<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="t_nombre" id="t_nombre" placeholder="Nombre empresa o tienda" required>
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
            <label class="col-form-label" for="t_direccion">Dirección</label>
            <input type="text" class="form-control" name="t_direccion" id="t_direccion" placeholder="Dirección" required>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <label class="col-form-label" for="t_telefono">Telefono</label>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea class="form-control" name="t_descripcion" id="t_descripcion" cols="30" rows="4"></textarea>
        </div>
    </div>
    <div class="col-md-6">
